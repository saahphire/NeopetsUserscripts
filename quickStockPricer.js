...
const init = async () => {
    ...
    const items = await fetchItemDb('https://itemdb.com.br/api/v2/items/many', 'Quick Stock Pricer', JSON.stringify({type: 'name', data: names, intent: 'pricer'})).catch(console.error);
