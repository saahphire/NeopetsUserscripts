...
const init = async () => {
    ...
    const items = await fetchItemDb('https://itemdb.com.br/api/v1/items/many', 'Quick Stock Pricer', JSON.stringify({name: names}));
...
// @icon         https://www.google.com/s2/favicons?sz=64&domain=neopets.com
// @license      Unlicense
// @require      https://update.greasyfork.org/scripts/567036/1843896/itemDB%20Fetch%20Lib.js
// ==/UserScript==
