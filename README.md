...
[<img width="1920" height="1080" alt="A screenshot of the blog" src="https://github.com/user-attachments/assets/045879b1-c92b-43a4-ae79-85926e1c7459" />](https://saahphire-userscripts.ct.ws)

I've made [a blog](https://saahphire-userscripts.ct.ws) for my userscripts so it's easier for you to find out whenever I post a new userscript! It has a newsletter, RSS feed, and posts in chronological order. From now on, that's where I'll keep the descriptions of each userscript. To find one, just use the search bar and use spaces wherever there's capitalization (so addPostNumberToTopics.js = Add Post Number to Topics).
